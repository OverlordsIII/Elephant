...
function setupAnswers(){
    ...
    if(reviewCards[randomCard] === 1) reviewCards[randomCard] = true;
    else reviewCards[randomCard] = 1;
    ...
    if(reviewCards[randomCard] === 1){
        ...
        correctAnswers = reviewDeck.cards[randomCard][1];
